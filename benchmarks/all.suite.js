...
import {of, allP} from "../lib";
import nameFn from "../lib/internal/namefn";
...
suite
  ...
  .add("native five promises", {
    defer: true,
    fn: deferred => Promise.all(fivePromises()).then(() => deferred.resolve()),
  })
  ...
  .add("allTyped2 five promises", {
    defer: true,
    fn: deferred => allTyped2(fivePromises())().then(() => deferred.resolve()),
  })
  // Ten Promises
